        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        Graduated with a 1<sup>st</sup> class degree at the
                        University of Mauritius
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography sx={{ fontFamily: "'Nunito', sans-serif" }}>
                        Taking on my tertiary education from 2016 to 2019, being
                        exposed to topics such as:
                        <ol>
            ...
            >
                ...
                >
                    ...
                    >
                        Completed HSC at Sir Abdool Raman Osman State College in
                        the Technical Field
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography sx={{ fontFamily: "'Nunito', sans-serif" }}>
                        Studied the following subjects, graded with the
                        following:
                        <ol>
                            <li>Mathematics: A</li>
                            <li>Physics: B</li>
            ...
            >
                ...
                >
                    ...
                    >
                        Completed SC at Sir Abdool Raman Osman State College in
                        the Technical Field
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
